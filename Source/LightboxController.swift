...
public protocol LightboxControllerPageDelegate: class {
    ...
    func lightBoxAlbumOnclick()
    func lightBoxReplyOnclick()
}
...
open class LightboxController: UIViewController {
    ...
    open override func viewDidLayoutSubviews() {
        ...
        if #available(iOS 11, *) {
            header_height += view.safeAreaInsets.top
            footer_height += view.safeAreaInsets.bottom
        }
...
extension LightboxController: FooterViewDelegate {
    public func footerView(_ footerView: FooterView, didPressReplyButton replyButton: UIButton) {
        pageDelegate!.lightBoxReplyOnclick()
    }
    
    public func footerView(_ footerView: FooterView, didPressAlbumButton albumButton: UIButton) {
        pageDelegate!.lightBoxAlbumOnclick()
    }
